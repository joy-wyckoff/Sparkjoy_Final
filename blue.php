...
<body>
	...
	<div class="main-w3layouts wrapper">
		...
		<div class="main-agileinfo">
			<div class="agileits-top">
				...
				<div id= "container">
				<form method="post">
					<input class="input" type="text" name="first_name" id="first_name" placeholder= "First Name" required /><br><br>
					<input class="input" type="text" name="last_name" id="last_name" placeholder="Last Name" required/><br><br>
	...
	<?php if (isset($_POST['register'])){
	  ...
	  $q="INSERT INTO `users` (`id`, `user_name`, `password`,`first_name`,`last_name`,`grade`,`high_school`,`email`) VALUES('', '".$user_name."', '".$password."','".$first_name."','".$last_name."','".$grade."','".$high_school."','".$email."',)" ;
